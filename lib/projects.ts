...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    name: 'GGType',
    status: 'live',
    desc: 'A gamer-focused typing arena. Type real in-game callouts like Overwatch\'s "Aggressive!" inside a live team chat that reacts to how clean (or messy) your run is.',
    role: 'designer · developer',
    period: '2026',
    stack: ['Next.js', 'TypeScript', 'Tailwind CSS'],
    tags: ['next.js', 'typing', 'game'],
    features: [
      'Esports HUD — three-column layout: live stats, team chat, match history',
      'Ambient team chat — allies and enemies post lines on a timer while you play',
      'Word pools — Overwatch themed sentences (extra packs can ship over time)',
      'EN / TH — English and Thai sentence sets',
      'Hype vs Rage — green supportive vibe or red trash-talk vibe for chat flavor',
      'Auto-Rage — optional flip to Rage when accuracy drops below 85% after 12 keystrokes',
      'Duration options — 15s · 30s · 60s · 120s',
      'Live stats — WPM, accuracy, sentences completed, error count',
      'Match history — last 25 runs in localStorage',
    ],
    metrics: [
      { k: 'modes', v: '2' },
      { k: 'rage msg', v: '67' },
    ...
    primaryLabel: 'open game',
    primaryHref: 'https://gg-type.vercel.app/',
    secondaryLabel: 'browse repo',
    secondaryHref: 'https://github.com/NopksForge/gg-type',
    previewCarouselIntervalMs: CAROUSEL_INTERVAL_MS,
  },
  {
    id: "infinite",
